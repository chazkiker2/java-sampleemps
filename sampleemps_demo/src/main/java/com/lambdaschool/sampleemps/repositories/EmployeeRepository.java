...
public interface EmployeeRepository
	...
	//"SELECT e.name as employee_name, count(et.employeeid) as count_job_titles FROM employees e LEFT JOIN
	// employeetitles et ON e.employeeid = et.employeeid GROUP BY e.name"
	@Query(value=
